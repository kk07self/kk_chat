...
class ItemsView: UIView {
    ...
    fileprivate func xibSetup() {
        ...
        collectionView.collectionViewLayout = ChatCollectionViewFlowLayout.chatCollectionViewFlowLayout(sections: 4, rows: 2, pageSize: CGSize(width:kScreenWidth, height:180), pageSpacing: 10, columnSpacing: 0, rowSpacing: 0, edgeInsets: UIEdgeInsets(top: 15, left: 0, bottom: 0, right: 0))
